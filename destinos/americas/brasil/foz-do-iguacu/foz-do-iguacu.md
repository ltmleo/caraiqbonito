...
As Cataratas são a razão pela qual Foz existe como destino turístico — mas a cidade tem muito mais camadas do que isso. A Itaipu Binacional, que divide seu complexo de turbinas entre o Brasil e o Paraguai, produz energia suficiente para abastecer todo o Brasil por meses com apenas um dia de operação. O Marco das Três Fronteiras é o único ponto do mundo onde Brasil, Argentina e Paraguai se tocam fisicamente, com o encontro visível dos rios Iguaçu e Paraná e três monumentos iluminados em verde, branco e azul ao entardecer. O Parque das Aves tem 1.400 pássaros de 150 espécies que pousam no seu ombro se você ficar quieto tempo suficiente.
...
**Série:** *Our Planet* (Netflix, narrado por David Attenborough) — o episódio sobre rios inclui imagens aéreas das Cataratas do Iguaçu que são de partir o coração; excelente para antes da viagem

**Livros:** *Guia da Fauna do Parque Nacional do Iguaçu* (editoras regionais) — útil para identificar o que você vai ver nas trilhas; a fauna do parque inclui mais de 400 espécies de aves, onças pintadas, tamanduás e quatis (estes últimos, inevitáveis)

**Música:** Nenhum artista específico, mas a trilha sonora de Foz é o próprio som das quedas — que pode ser ouvido a quilômetros de distância quando a vazão está alta

---

*Fontes: Wikipedia PT ([Foz do Iguaçu](https://pt.wikipedia.org/wiki/Foz_do_Igua%C3%A7u), [Cataratas do Iguaçu](https://pt.wikipedia.org/wiki/Cataratas_do_Igua%C3%A7u)); [H2FOZ — História](https://www.h2foz.com.br/cidade/foz-do-iguacu-108-anos-historia-da-terra-das-cataratas-e-bem-mais-antiga/); [Portal da Cidade — Foz](https://foz.portaldacidade.com/historia-de-foz%20do%20iguacu-pr); [Wish Resort — História e Cultura](https://www.grupowish.com/dicas-de-viagem/historia-e-cultura-de-foz-do-iguacu-um-passeio-pelo-passado-da-regiao)*
