...
> **Resumo:** A Istambul além dos monumentos obrigatórios é uma cidade de bairros: cada um tem seu próprio cheiro, sua própria paleta de cores e seu próprio ritmo. O Grande Bazar é um universo paralelo que existe há mais de 500 anos. Balat é a memória das comunidades que a cidade abrigou. Karaköy é a Istambul que se reinventa. A Torre de Gálata é o mirante que coloca tudo em perspectiva. E o hammam é a experiência que nenhum hotel europeu consegue imitar.

## Grande Bazar (*Kapalıçarşı*)

O Grande Bazar é o mercado coberto mais antigo do mundo ainda em funcionamento e, com as suas mais de 4.000 lojas distribuídas por 61 ruas cobertas, possivelmente o maior. Fundado pelo sultão Maomé II em 1461 — logo após a conquista de Constantinopla, como fonte de renda para custear a manutenção de Santa Sofia —, o bazar nunca fechou: sobreviveu a terremotos, incêndios, ocupações e impérios.
...
📸 [Fotos no Google Maps](https://www.google.com/maps/search/Balat+Fener+bairro+Istambul)

---

## Torre de Gálata (*Galata Kulesi*) e Bairro de Karaköy

A Torre de Gálata foi construída pelos genoveses em 1348 como o ponto mais alto da colônia de Gálata — que ficava fora dos muros de Constantinopla e era administrada de forma autônoma, como uma cidade-estado dentro da cidade imperial. Com seus 67 metros de altura, a torre servia de farol, prisão e posto de observação, e hoje oferece a vista panorâmica de 360 graus mais acessível de Istambul: o Corno de Ouro, o Bósforo, a Península Histórica com suas mesquitas e o lado asiático da cidade ao mesmo tempo. Os ingressos esgotam cedo na alta temporada — reserve online.
...
- **Çemberlitaş Hamamı** (1584, projetado por Sinan, a 5 min do Grande Bazar) — o mais histórico, com bom serviço para turistas. Preço a partir de €50 para o pacote básico.
- **Kılıç Ali Paşa Hamamı** (1583, em Karaköy) — recentemente restaurado, o mais bonito dos hammams históricos em termos de conservação do mármore e da cúpula. Reserva obrigatória.
- **Cağaloğlu Hamamı** (1741) — o mais famoso internacionalmente, frequentado por Franz Liszt, Florence Nightingale e Tony Curtis ao longo dos séculos, segundo o arquivo histórico do próprio estabelecimento.

Dica: banhos separados para homens e mulheres na maioria dos hammams históricos. Roupa de baixo pode ser mantida. Gorjeta ao *tellak* (atendente) é esperada — cerca de 15%–20% do valor.

📸 [Fotos no Google Maps](https://www.google.com/maps/search/Cemberlitas+Hamami+Istambul)

---

## Kadıköy — o lado asiático
...
📸 [Fotos no Google Maps](https://www.google.com/maps/search/Kadiköy+Istambul+lado+asiático)

---

*Fontes: [CNN Brasil](https://www.cnnbrasil.com.br/viagemegastronomia/viagem/o-que-fazer-em-istambul-10-pontos-turisticos-imperdiveis-e-outras-dicas/); [Viagens Fora do Comum — Grande Bazar](https://viagensforadocomum.com.br/blog/turquia/tudo-sobre-o-grand-bazaar/); [360 Meridianos](https://www.360meridianos.com/o-que-fazer-em-istambul/); [Lugares Incertos](https://www.lugaresincertos.com/inspiracao-viagem/istambul-que-fazer-turquia-capital-romantica/); [Hellotickets](https://www.hellotickets.com.br/turquia/istambul/bairros-de-istambul/sc-185-2754); [Grupo Dicas](https://www.grupodicas.com/roteiro-perfeito-de-4-5-6-e-7-dias-em-istambul/)*
